...
os.chdir("/Users/alexgjl/Desktop/PD_across_the_tree_of_life_files")#change this direction to where you have the required datasets
...
print(ls_pd)
end_time = time.time()
print(f"time: {end_time - start_time:.2f} second")
